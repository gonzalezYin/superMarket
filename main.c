...
void goods_inquiry(double finance[]){
	...
	while (i == 1 || i == 2 || i == 3 || i == 4 || i == 5 || i == 6)
	{
		...
		{
			system("cls");
			change_goods(finance); //调用修改商品的函数
			system("pause");
			system("cls");
		}
		if (i == 4)  //统计商品 
